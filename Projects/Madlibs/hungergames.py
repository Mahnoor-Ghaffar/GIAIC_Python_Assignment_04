# This is a Mad Libs game—a fun interactive story-building program where the user fills in blanks with random words (like nouns, verbs, adjectives),
# and the program inserts them into a prewritten story for a funny or creative result.
